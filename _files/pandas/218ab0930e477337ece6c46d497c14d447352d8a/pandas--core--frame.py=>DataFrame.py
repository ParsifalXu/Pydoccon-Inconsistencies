class DataFrame(NDFrame, OpsMixin):
    ...
    def __init__(self, data=None, index: Axes | None=None, columns: Axes | None=None, dtype: Dtype | None=None, copy: bool | None=None) -> None:
        ...
        if isinstance(data, (BlockManager, ArrayManager)):
            ...
            if isinstance(data, mrecords.MaskedRecords):
                ...
                warnings.warn('Support for MaskedRecords is deprecated and will be removed in a future version.  Pass {name: data[name] for name in data.dtype.names} instead.', FutureWarning, stacklevel=find_stack_level())
            else:
            ...
            if data.dtype.names:
                ...
                mgr = dict_to_mgr({data.name: data}, index, columns, dtype=dtype, typ=manager)
            else:
                mgr = ndarray_to_mgr(data, index, columns, dtype=dtype, copy=copy, typ=manager)
    ...
    def to_dict(self, orient: Literal['dict', 'list', 'series', 'split', 'tight', 'records', 'index']='dict', into: type[dict]=dict, index: bool=True) -> dict | list[dict]:
        """
        ...
        if orient == 'dict':
            ...
            return into_c(((('index', self.index.tolist()),) if index else ()) + (('columns', self.columns.tolist()), ('data', [list(map(maybe_box_native, t)) for t in self.itertuples(index=False, name=None)])))
        elif orient == 'tight':
            return into_c(((('index', self.index.tolist()),) if index else ()) + (('columns', self.columns.tolist()), ('data', [list(map(maybe_box_native, t)) for t in self.itertuples(index=False, name=None)])) + ((('index_names', list(self.index.names)),) if index else ()) + (('column_names', list(self.columns.names)),))
        elif orient == 'series':
            ...
            return into_c(((t[0], dict(zip(self.columns, map(maybe_box_native, t[1:])))) for t in self.itertuples(name=None)))
        else:
            raise ValueError(f"orient '{orient}' not understood")

    def to_gbq(self, destination_table: str, project_id: str | None=None, chunksize: int | None=None, reauth: bool=False, if_exists: str='fail', auth_local_webserver: bool=True, table_schema: list[dict[str, str]] | None=None, location: str | None=None, progress_bar: bool=True, credentials=None) -> None:
        """
    ...
    @classmethod
    def _from_arrays(cls, arrays, columns, index, dtype: Dtype | None=None, verify_integrity: bool=True) -> DataFrame:
        """
    ...
    def to_markdown(self, buf: FilePath | WriteBuffer[str] | None=None, mode: str='wt', index: bool=True, storage_options: StorageOptions=None, **kwargs) -> str | None:
        if 'showindex' in kwargs:
            warnings.warn("'showindex' is deprecated. Only 'index' will be used in a future version. Use 'index' to silence this warning.", FutureWarning, stacklevel=find_stack_level())
    ...
    def to_parquet(self, path: FilePath | WriteBuffer[bytes] | None=None, engine: str='auto', compression: str | None='snappy', index: bool | None=None, partition_cols: list[str] | None=None, storage_options: StorageOptions=None, **kwargs) -> bytes | None:
        """
    ...
    def info(self, verbose: bool | None=None, buf: WriteBuffer[str] | None=None, max_cols: int | None=None, memory_usage: bool | str | None=None, show_counts: bool | None=None, null_counts: bool | None=None) -> None:
        if null_counts is not None:
            if show_counts is not None:
                raise ValueError('null_counts used with show_counts. Use show_counts.')
            warnings.warn('null_counts is deprecated. Use show_counts instead', FutureWarning, stacklevel=find_stack_level())
    ...
    def lookup(self, row_labels: Sequence[IndexLabel], col_labels: Sequence[IndexLabel]) -> np.ndarray:
        ...
        numpy.ndarray
            The found values.
        """
        msg = "The 'lookup' method is deprecated and will be removed in a future version. You can use DataFrame.melt and DataFrame.loc as a substitute."
    ...
    def _reindex_index(self, new_index, method, copy: bool, level: Level, fill_value=np.nan, limit=None, tolerance=None):
    ...
    def _reindex_columns(self, new_columns, method, copy: bool, level: Level, fill_value=None, limit=None, tolerance=None):
    ...
    def align(self, other: DataFrame, join: AlignJoin='outer', axis: Axis | None=None, level: Level=None, copy: bool=True, fill_value=None, method: FillnaOptions | None=None, limit: int | None=None, fill_axis: Axis=0, broadcast_axis: Axis | None=None) -> DataFrame:
    ...
    @overload
    def set_axis(self, labels, *, axis: Axis=..., inplace: Literal[False] | lib.NoDefault=..., copy: bool | lib.NoDefault=...) -> DataFrame:
        ...

    @overload
    def set_axis(self, labels, *, axis: Axis=..., inplace: Literal[True], copy: bool | lib.NoDefault=...) -> None:
        ...

    @overload
    def set_axis(self, labels, *, axis: Axis=..., inplace: bool | lib.NoDefault=..., copy: bool | lib.NoDefault=...) -> DataFrame | None:
        ...
    ...
    def set_axis(self, labels, *, axis: Axis=0, inplace: bool | lib.NoDefault=lib.no_default, copy: bool | lib.NoDefault=lib.no_default):
        return super().set_axis(labels, axis=axis, inplace=inplace, copy=copy)

    @Substitution(**_shared_doc_kwargs)
    @Appender(NDFrame.reindex.__doc__)
    @rewrite_axis_style_signature('labels', [('method', None), ('copy', None), ('level', None), ('fill_value', np.nan), ('limit', None), ('tolerance', None)])
    ...
    def drop(self, labels: IndexLabel=None, axis: Axis=0, index: IndexLabel=None, columns: IndexLabel=None, level: Level=None, inplace: bool=False, errors: IgnoreRaise='raise') -> DataFrame | None:
        """
    ...
    def rename(self, mapper: Renamer | None=None, *, index: Renamer | None=None, columns: Renamer | None=None, axis: Axis | None=None, copy: bool | None=None, inplace: bool=False, level: Level=None, errors: IgnoreRaise='ignore') -> DataFrame | None:
        """
        Alter axes labels.
    ...
    def fillna(self, value: Hashable | Mapping | Series | DataFrame=None, method: FillnaOptions | None=None, axis: Axis | None=None, inplace: bool=False, limit: int | None=None, downcast: dict | None=None) -> DataFrame | None:
    ...
    def replace(self, to_replace=None, value=lib.no_default, *, inplace: bool=False, limit: int | None=None, regex: bool=False, method: Literal['pad', 'ffill', 'bfill'] | lib.NoDefault=lib.no_default) -> DataFrame | None:
    ...
    def shift(self, periods: int=1, freq: Frequency | None=None, axis: Axis=0, fill_value: Hashable=lib.no_default) -> DataFrame:
        ...
        if axis == 1 and periods != 0 and (freq is None) and (fill_value is lib.no_default) and (ncols > 0):
            ...
            if len(arrays) > 1 or (not can_hold_element(arrays[0], fill_value) and (not (lib.is_integer(fill_value) and needs_i8_conversion(arrays[0].dtype)))):
                nper = abs(periods)
                nper = min(nper, ncols)
                if periods > 0:
    ...
    def reset_index(self, level: IndexLabel=None, drop: bool=False, inplace: bool=False, col_level: Hashable=0, col_fill: Hashable='', allow_duplicates: bool | lib.NoDefault=lib.no_default, names: Hashable | Sequence[Hashable]=None) -> DataFrame | None:
        """
    ...
    @overload
    def dropna(self, *, axis: Axis=..., how: AnyAll | NoDefault=..., thresh: int | NoDefault=..., subset: IndexLabel=..., inplace: Literal[False]=...) -> DataFrame:
        ...

    @overload
    def dropna(self, *, axis: Axis=..., how: AnyAll | NoDefault=..., thresh: int | NoDefault=..., subset: IndexLabel=..., inplace: Literal[True]) -> None:
        ...

    @deprecate_nonkeyword_arguments(version=None, allowed_args=['self'])
    def dropna(self, axis: Axis=0, how: AnyAll | NoDefault=no_default, thresh: int | NoDefault=no_default, subset: IndexLabel=None, inplace: bool=False) -> DataFrame | None:
        """
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=['self'])
    def sort_index(self, axis: Axis=0, level: IndexLabel=None, ascending: bool | Sequence[bool]=True, inplace: bool=False, kind: SortKind='quicksort', na_position: NaPosition='last', sort_remaining: bool=True, ignore_index: bool=False, key: IndexKeyFunc=None) -> DataFrame | None:
        """
    ...
    def combine_first(self, other: DataFrame) -> DataFrame:
        ...
        dtypes = {col: find_common_type([self.dtypes[col], other.dtypes[col]]) for col in self.columns.intersection(other.columns) if not is_dtype_equal(combined.dtypes[col], self.dtypes[col])}
        if dtypes:
    ...
    def groupby(self, by=None, axis: Axis=0, level: IndexLabel | None=None, as_index: bool=True, sort: bool=True, group_keys: bool | lib.NoDefault=no_default, observed: bool=False, dropna: bool=True) -> DataFrameGroupBy:
    ...
    @deprecate_nonkeyword_arguments(version=None, allowed_args=['self'])
    def pivot(self, index=lib.NoDefault, columns=lib.NoDefault, values=lib.NoDefault) -> DataFrame:
    ...
    def pivot_table(self, values=None, index=None, columns=None, aggfunc: AggFuncType='mean', fill_value=None, margins: bool=False, dropna: bool=True, margins_name: Level='All', observed: bool=False, sort: bool=True) -> DataFrame:
    ...
    def melt(self, id_vars=None, value_vars=None, var_name=None, value_name: Hashable='value', col_level: Level=None, ignore_index: bool=True) -> DataFrame:
    ...
    def any(self, axis: Axis=0, bool_only: bool | None=None, skipna: bool=True, level: Level=None, **kwargs) -> DataFrame | Series:
        ...
    ...
    def apply(self, func: AggFuncType, axis: Axis=0, raw: bool=False, result_type: Literal['expand', 'reduce', 'broadcast'] | None=None, args=(), **kwargs):
        ...
        **kwargs
        ...
        """
        from pandas.core.apply import frame_apply
        op = frame_apply(self, func=func, axis=axis, raw=raw, result_type=result_type, args=args, kwargs=kwargs)
    ...
    def append(self, other, ignore_index: bool=False, verify_integrity: bool=False, sort: bool=False) -> DataFrame:
        """
        ...
        4  4
        """
        warnings.warn('The frame.append method is deprecated and will be removed from pandas in a future version. Use pandas.concat instead.', FutureWarning, stacklevel=find_stack_level())
    ...
    def join(self, other: DataFrame | Series | list[DataFrame | Series], on: IndexLabel | None=None, how: str='left', lsuffix: str='', rsuffix: str='', sort: bool=False, validate: str | None=None) -> DataFrame:
        """
        ...
        5  K1  A5   B1
        """
        return self._join_compat(other, on=on, how=how, lsuffix=lsuffix, rsuffix=rsuffix, sort=sort, validate=validate)

    def _join_compat(self, other: DataFrame | Series | Iterable[DataFrame | Series], on: IndexLabel | None=None, how: str='left', lsuffix: str='', rsuffix: str='', sort: bool=False, validate: str | None=None):
        from pandas.core.reshape.concat import concat
    ...
    def merge(self, right: DataFrame | Series, how: str='inner', on: IndexLabel | None=None, left_on: IndexLabel | None=None, right_on: IndexLabel | None=None, left_index: bool=False, right_index: bool=False, sort: bool=False, suffixes: Suffixes=('_x', '_y'), copy: bool=True, indicator: str | bool=False, validate: str | None=None) -> DataFrame:
        from pandas.core.reshape.merge import merge
    ...
    def corr(self, method: CorrelationMethod='pearson', min_periods: int=1, numeric_only: bool | lib.NoDefault=lib.no_default) -> DataFrame:
        """
    ...
    def cov(self, min_periods: int | None=None, ddof: int | None=1, numeric_only: bool | lib.NoDefault=lib.no_default) -> DataFrame:
        """
    ...
    def corrwith(self, other: DataFrame | Series, axis: Axis=0, drop: bool=False, method: CorrelationMethod='pearson', numeric_only: bool | lib.NoDefault=lib.no_default) -> Series:
        """
        ...
        if method == 'pearson':
            ...
            num = (ldem * rdem).sum()
            dom = (left.count() - 1) * left.std(numeric_only=numeric_only_bool) * right.std(numeric_only=numeric_only_bool)
            correl = num / dom
    ...
    def count(self, axis: Axis=0, level: Level=None, numeric_only: bool=False):
        ...
        axis = self._get_axis_number(axis)
        if level is not None:
            warnings.warn('Using the level keyword in DataFrame and Series aggregations is deprecated and will be removed in a future version. Use groupby instead. df.count(level=1) should use df.groupby(level=1).count().', FutureWarning, stacklevel=find_stack_level())
    ...
    def _reduce(self, op, name: str, *, axis: Axis=0, skipna: bool=True, numeric_only: bool | None=None, filter_type=None, **kwds):
        ...
        if numeric_only is None and name in ['mean', 'median']:
            ...
            if dtype_is_dt.any():
                warnings.warn('DataFrame.mean and DataFrame.median with numeric_only=None will include datetime64 and datetime64tz columns in a future version.', FutureWarning, stacklevel=find_stack_level())
        ...
        try:
            ...
            if name in ['all', 'any']:
                arg_name = 'bool_only'
            warnings.warn(f"Dropping of nuisance columns in DataFrame reductions (with '{arg_name}=None') is deprecated; in a future version this will raise TypeError.  Select only valid columns before calling the reduction.", FutureWarning, stacklevel=find_stack_level())
    ...
    @overload
    def quantile(self, q: float=..., axis: Axis=..., numeric_only: bool | lib.NoDefault=..., interpolation: QuantileInterpolation=...) -> Series:
        ...

    @overload
    def quantile(self, q: AnyArrayLike | Sequence[float], axis: Axis=..., numeric_only: bool | lib.NoDefault=..., interpolation: QuantileInterpolation=...) -> Series | DataFrame:
        ...

    @overload
    def quantile(self, q: float | AnyArrayLike | Sequence[float]=..., axis: Axis=..., numeric_only: bool | lib.NoDefault=..., interpolation: QuantileInterpolation=...) -> Series | DataFrame:
        ...

    def quantile(self, q: float | AnyArrayLike | Sequence[float]=0.5, axis: Axis=0, numeric_only: bool | lib.NoDefault=no_default, interpolation: QuantileInterpolation='linear', method: Literal['single', 'table']='single') -> Series | DataFrame:
        """
        ...
        if method == 'single':
            ...
            q_idx = np.quantile(np.arange(len(data)), q, **{np_percentile_argname: interpolation})
            by = data.columns
            if len(by) > 1:
    ...
    def resample(self, rule, axis: Axis=0, closed: str | None=None, label: str | None=None, convention: str='start', kind: str | None=None, loffset=None, base: int | None=None, on: Level=None, level: Level=None, origin: str | TimestampConvertibleTypes='start_day', offset: TimedeltaConvertibleTypes | None=None, group_keys: bool | lib.NoDefault=no_default) -> Resampler:
        return super().resample(rule=rule, axis=axis, closed=closed, label=label, convention=convention, kind=kind, loffset=loffset, base=base, on=on, level=level, origin=origin, offset=offset, group_keys=group_keys)

    def to_timestamp(self, freq: Frequency | None=None, how: str='start', axis: Axis=0, copy: bool=True) -> DataFrame:
        """
    ...
    def to_period(self, freq: Frequency | None=None, axis: Axis=0, copy: bool=True) -> DataFrame:
        """
    ...
    def isin(self, values: Series | DataFrame | Sequence | Mapping) -> DataFrame:
        ...
        if isinstance(values, dict):
            ...
            result = self._constructor(algorithms.isin(self.values.ravel(), values).reshape(self.shape), self.index, self.columns)
    ...
    def ffill(self, *, axis: None | Axis=None, inplace: bool=False, limit: None | int=None, downcast: dict | None=None) -> DataFrame | None:
    ...
    def bfill(self, *, axis: None | Axis=None, inplace: bool=False, limit: None | int=None, downcast=None) -> DataFrame | None:
        return super().bfill(axis=axis, inplace=inplace, limit=limit, downcast=downcast)

    def clip(self: DataFrame, lower: float | None=None, upper: float | None=None, *, axis: Axis | None=None, inplace: bool=False, **kwargs) -> DataFrame | None:
        return super().clip(lower, upper, axis=axis, inplace=inplace, **kwargs)

    @deprecate_nonkeyword_arguments(version=None, allowed_args=['self', 'method'])
    def interpolate(self: DataFrame, method: str='linear', axis: Axis=0, limit: int | None=None, inplace: bool=False, limit_direction: str | None=None, limit_area: str | None=None, downcast: str | None=None, **kwargs) -> DataFrame | None:
        return super().interpolate(method, axis, limit, inplace, limit_direction, limit_area, downcast, **kwargs)

    @overload
    def where(self, cond, other=..., *, inplace: Literal[False]=..., axis: Axis | None=..., level: Level=..., errors: IgnoreRaise | lib.NoDefault=...) -> DataFrame:
        ...

    @overload
    def where(self, cond, other=..., *, inplace: Literal[True], axis: Axis | None=..., level: Level=..., errors: IgnoreRaise | lib.NoDefault=...) -> None:
        ...

    @overload
    def where(self, cond, other=..., *, inplace: bool=..., axis: Axis | None=..., level: Level=..., errors: IgnoreRaise | lib.NoDefault=...) -> DataFrame | None:
        ...

    @deprecate_kwarg(old_arg_name='errors', new_arg_name=None)
    def where(self, cond, other=lib.no_default, *, inplace: bool=False, axis: Axis | None=None, level: Level=None, errors: IgnoreRaise | lib.NoDefault='raise') -> DataFrame | None:
        return super().where(cond, other, inplace=inplace, axis=axis, level=level)

    @overload
    def mask(self, cond, other=..., *, inplace: Literal[False]=..., axis: Axis | None=..., level: Level=..., errors: IgnoreRaise | lib.NoDefault=...) -> DataFrame:
        ...

    @overload
    def mask(self, cond, other=..., *, inplace: Literal[True], axis: Axis | None=..., level: Level=..., errors: IgnoreRaise | lib.NoDefault=...) -> None:
        ...

    @overload
    def mask(self, cond, other=..., *, inplace: bool=..., axis: Axis | None=..., level: Level=..., errors: IgnoreRaise | lib.NoDefault=...) -> DataFrame | None:
        ...

    @deprecate_kwarg(old_arg_name='errors', new_arg_name=None)
    def mask(self, cond, other=lib.no_default, *, inplace: bool=False, axis: Axis | None=None, level: Level=None, errors: IgnoreRaise | lib.NoDefault='raise') -> DataFrame | None:
        return super().mask(cond, other, inplace=inplace, axis=axis, level=level)