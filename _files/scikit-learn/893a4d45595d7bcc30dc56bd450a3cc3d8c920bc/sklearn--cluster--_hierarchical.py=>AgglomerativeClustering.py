class AgglomerativeClustering(ClusterMixin, BaseEstimator):
    ...
    def __init__(self, n_clusters=2, affinity='euclidean', memory=None, connectivity=None, compute_full_tree='auto', linkage='ward', distance_threshold=None):
    ...
    def fit(self, X, y=None):
        ...
        out = memory.cache(tree_builder)(X, connectivity, n_clusters=n_clusters, return_distance=return_distance, **kwargs)
